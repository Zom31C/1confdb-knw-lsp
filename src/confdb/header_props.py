...
# Коды периодичности регистра сведений. Подтверждены по семантике регистров:
# КоэффициентДефлятор=год, СведенияОВзносахВПФР=квартал,
# МинимальнаяОплатаТрудаРФ=месяц, КурсыВалют=день. Коды 5/6/7 встречаются
# (21 и 10 регистров в УНФ), но не расшифрованы — их не угадываем.
PERIODICITY = {'0': 'нет', '1': 'год', '2': 'квартал', '3': 'месяц', '4': 'день'}
